...
const Certificates = () => {
  ...
  const certificates = [
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: 'March 2023',
      description: 'Deep dive into JavaScript concepts including closures, prototypes, async programming, and ES6+ features.',
      icon: '⚡'
    },
    {
    ...
    },
    {
      ...
      date: 'August 2023',
      description: 'Comprehensive training in user interface design principles, user experience research, and prototyping.',
      icon: '🎨'
    }
  ];
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <motion.div 
                    ...
                    variants={itemVariants}
                  >
                    <span className="font-medium mr-2">{certificate.issuer}</span>
